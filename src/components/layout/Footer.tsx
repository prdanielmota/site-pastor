    ...
    <footer className="w-full border-t-4 border-black bg-background mt-12">
      <div className="container px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            <h4 className="text-base md:text-lg font-black uppercase tracking-wider border-b-2 border-black inline-block pb-1">Seções</h4>
            <ul className="space-y-2 text-sm font-bold">
              <li><Link href="/" className="hover:bg-accent hover:px-2 transition-all block w-fit border border-transparent hover:border-black">Início</Link></li>
              <li><Link href="/categoria/iasd" className="hover:bg-accent hover:px-2 transition-all block w-fit border border-transparent hover:border-black">IASD</Link></li>
              <li><Link href="/categoria/mundo" className="hover:bg-accent hover:px-2 transition-all block w-fit border border-transparent hover:border-black">Mundo</Link></li>
              <li><Link href="/categoria/profecias" className="hover:bg-accent hover:px-2 transition-all block w-fit border border-transparent hover:border-black">Profecias</Link></li>
            </ul>
          </div>
